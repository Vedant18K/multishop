                ...
                <div>
                    ...
                    <div>
                        <ul>
                            {QuickShop.map((item) => {
                                return (
                                    <li className='cursor-pointer'><a href={QuickShop.map} className='flex gap-2'><span>{">"}</span><div id='check'>{item}</div></a></li>
                                )
                            })}
                        </ul>
                    </div>
                ...
                <div>
                    ...
                    <div>
                        <ul>
                            {MyAccount.map((item) => {
                                return (
                                    <li className='cursor-pointer'><a href={MyAccount.map} className='flex gap-2'><span>{">"}</span><div className='hover:underline'>{item}</div></a></li>
                                )
                            })}
                        </ul>
                    </div>
